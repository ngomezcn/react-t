              ...
              <ul className="navbar-nav">
                ...
                <li className="nav-item dropdown">
                  <Link
                    ...
                    className="nav-link dropdown-toggle arrow-none"
                  >
                    <i className="dripicons-document me-2"></i>
                    {props.t("Assessments")} <div className="arrow-down"></div>
                  </Link>
                  <div className={classname("dropdown-menu", { show: app })}>

                    <Link to="/available-questionnaires" className="dropdown-item">
                      {props.t("Assessment Search")}
                    </Link>
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    ...
                    {props.t("Questions")} <div className="arrow-down"></div>
                  </Link>
                  <div className={classname("dropdown-menu", { show: app })}>
                    <Link to="/available-questionnaires" className="dropdown-item">
                      {props.t("Question Search")}
                    </Link>

                    <Link to="/available-questionnaires" className="dropdown-item">
                      {props.t("Score By Level")}
                    </Link>
                    ...
                    <div className="dropdown">
                      ...
                      >
                        {props.t("Add Question")} <div className="arrow-down"></div>
                      </Link>
                      <div
                        className={classname("dropdown-menu", { show: addquestion })}
                      >
                        <Link to="/create-question" className="dropdown-item">
                          {props.t("Manual Input")}
                        </Link>
                        <Link to="/import-assessments" className="dropdown-item">
                          {props.t("Import .csv")}
                        </Link>
                      </div>
                    </div>
                ...
                <li className="nav-item dropdown">
                  <Link
                    ...
                    className="nav-link dropdown-togglez arrow-none"
                  >
                    <i className="mdi mdi-tag-multiple-outline me-2"></i>
                    {props.t("Categories")} <div className="arrow-down"></div>
                  </Link>

                  <div className={classname("dropdown-menu", { show: app })}>
                    <Link to="/categories" className="dropdown-item">
                      {props.t("Category Search")}
                    </Link>
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    <i className="mdi mdi-book-account-outline me-2"></i>
                    {props.t("Students")} <div className="arrow-down"></div>
                  </Link>
                  <div className={classname("dropdown-menu", { show: app })}>
                    <Link to="/categories" className="dropdown-item">
                      {props.t("Search Students")}
                    </Link>
                    <Link to="/apps-filemanager" className="dropdown-item">
                      {props.t("Import")}
                    </Link>
                ...
                <li className="nav-item dropdown">
                  <Link
                    ...
                    to="/other"
                  >
                    {props.t("template_samples")} {props.menuOpen}
                  ...
                  <div className={classname("dropdown-menu", { show: other })}>
                    ...
                    <li className="nav-item dropdown">
                      ...
                      >
                        ...
                        {props.t("Exams")} <div className="arrow-down"></div>
                      </Link>
                      <div
                        className={classname(
                    ...
                    <li className="nav-item dropdown">
                      ...
                      >
                        ...
                        {props.t("Question Pools")} <div className="arrow-down"></div>
                      </Link>
                      <div className={classname("dropdown-menu", { show: app })}>
