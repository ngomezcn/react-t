import { Discount, Product, RecentProducts, Comment, ProductOrder, ProductCustomer, EComShop, cart, Answer } from "pages/Ecommerce/type";
...
const orders: Answer[] = [
  {
    id: 1,
    answer: "Neeeal Matthews",
    correct: false
  },
  {
    id: 2,
    answer: "Jamal Burnett",
    correct: false
  },
  {
    id: 3,
